    ...
    <tr>
        <td style="width:33%"><br>
            <a href="https://www.instagram.com/p/CACM9-gH593/">
                <image src="{{site.baseurl}}/images/CCA-10-pin_bowling_IG1.png" style="display:block;margin-left:auto;margin-right:auto;" alt="10 Pin Bowling">
                </image>
            </a>
            type here
        </td>
        <td style="width:33%"><br>
            <a href="https://www.instagram.com/p/B9ZQ-KQHuvH/">
                ...
                <h6 style="margin-top:0%">heretoo can add the colour accent. type here if you want the title to be clickable</h6>
                </image>
            </a>
        </td>
        <td style="width:33%"><br>
            ...
            <h6 style="margin-top:0%">if not it will be here and not clickable</h6>
        </td>
    </tr>
</table>
